...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-q87t4pw.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-q87t4pw.containers.anotherwebservice.com/
...
```
git clone git@github.com:bugsauce24/container-q87t4pw.git
cd container-q87t4pw
```
...
```
docker attach container-q87t4pw
```
